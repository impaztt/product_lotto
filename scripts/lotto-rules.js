(function initLottoRules(global) {
    ...
    const RULE_NARRATIVES = {
        all_odd: { why: "홀짝이 한쪽으로 완전히 기운 극단 조합이라 가장 먼저 정리하는 기본 필터입니다." },
        all_even: { why: "짝수만 몰린 극단 패턴을 먼저 걷어내고 싶을 때 쓰는 시작 필터입니다." },
        five_odd_one_even: { why: "홀수 쏠림을 줄여 보다 균형적인 분포만 남기고 싶을 때 자주 고릅니다." },
        five_even_one_odd: { why: "짝수 편중 조합을 줄여 한쪽으로 기운 후보를 빠르게 정리할 때 적합합니다." },
        four_odd_two_even: { why: "홀수 우세 조합을 덜어내며 분포 편향을 한 단계 더 줄이고 싶을 때 쓰는 필터입니다." },
        four_even_two_odd: { why: "짝수 우세 조합을 줄여 홀짝 균형을 더 깔끔하게 맞추고 싶을 때 선택합니다." },
        multiples_of_2_4_plus: { why: "짝수가 과하게 많은 조합을 한 번에 정리해 후보를 크게 줄이는 대표 강필터입니다." },
        multiples_of_2_5_plus: { why: "짝수가 거의 대부분인 조합만 따로 걷어내는 보강 필터로, 더 강한 정리를 원할 때 유용합니다." },
        multiples_of_3_3_plus: { why: "3의 배수 쏠림을 줄여 특정 배수 패턴 반복을 싫어하는 사용자에게 잘 맞습니다." },
        multiples_of_4_3_plus: { why: "4의 배수 편중 조합을 덜어내며 배수 몰림까지 함께 관리하고 싶을 때 씁니다." },
        multiples_of_5_3_plus: { why: "끝자리 0과 5가 많은 조합이 부담스러울 때 가볍게 정리하기 좋은 배수 필터입니다." },
        multiples_of_6_3_plus: { why: "2와 3의 성질이 겹친 숫자 몰림을 줄여 보다 다양한 결로 후보를 남기고 싶을 때 사용합니다." },
        multiples_of_7_3_plus: { why: "출현 빈도가 상대적으로 적은 7의 배수 편중을 세밀하게 조정하는 미세 필터입니다." },
        consecutive_3_plus: { why: "연속수가 길게 붙은 조합을 싫어하는 사용자들이 가장 많이 체감하는 대표 필터입니다." },
        consecutive_4_plus: { why: "연속수가 아주 길게 붙은 강한 패턴만 제거하는 정밀 보정용 필터입니다." },
        same_last_digit_3_plus: { why: "끝자리가 세 개 이상 겹치면 시각적으로도 몰려 보여 먼저 정리하고 싶은 수요가 많습니다." },
        same_last_digit_4_plus: { why: "끝자리 반복이 아주 심한 패턴만 골라내는 강한 끝자리 보정 필터입니다." },
        last_digit_2_plus: { why: "끝자리 중복 자체를 크게 싫어할 때 쓰는 고강도 필터로, 후보를 매우 크게 압축합니다." },
        last_digit_zero_2_plus: { why: "10, 20, 30, 40처럼 0으로 끝나는 숫자 몰림을 따로 싫어하는 취향을 반영할 때 좋습니다." },
        last_digit_five_2_plus: { why: "5, 15, 25, 35, 45처럼 5로 끝나는 숫자 몰림을 따로 조정하고 싶을 때 적합합니다." },
        same_decade_4_plus: { why: "한 10단위 구간에 숫자가 몰리는 패턴을 줄여 구간 분산을 넓게 가져가고 싶을 때 씁니다." },
        same_decade_5_plus: { why: "거의 한 구간에 쏠린 조합만 제거하는 미세 구간 필터라 마지막 정리에 잘 맞습니다." },
        all_low_or_high: { why: "낮은 번호대나 높은 번호대 한쪽에만 몰린 극단 분포를 먼저 정리하는 기본 필터입니다." },
        low_or_high_5_plus: { why: "저구간 또는 고구간 한쪽으로 심하게 기운 조합을 줄여 전체 구간 밸런스를 맞출 때 유용합니다." },
        low_1_15_4_plus: { why: "초반 번호대 쏠림을 줄여 너무 낮은 숫자 중심 조합을 피하고 싶을 때 선택합니다." },
        mid_16_30_4_plus: { why: "중간 구간에 몰린 조합을 덜어내며 특정 구간 편중을 세밀하게 관리할 때 좋습니다." },
        high_31_45_4_plus: { why: "후반 번호대 과밀을 줄여 높은 숫자 위주 후보를 정리하고 싶을 때 효과적입니다." },
        tight_range: { why: "숫자 폭이 좁은 조합을 빼고 더 넓게 퍼진 조합만 보고 싶을 때 가장 직관적인 필터입니다." },
        extreme_sum: { why: "합계가 너무 낮거나 높은 극단 조합을 한 번에 덜어내는 대표 합계 필터입니다." },
        sum_low_100: { why: "합계가 낮은 조합을 싫어할 때 쓰는 보정 필터로, 낮은 번호 쏠림 정리에 자주 함께 씁니다." },
        sum_high_180: { why: "합계가 높은 조합을 줄여 높은 번호 위주 조합을 마지막으로 다듬고 싶을 때 적합합니다." },
        prime_4_plus: { why: "소수가 지나치게 많은 패턴을 줄여 숫자 성질이 한쪽으로 기운 조합을 정리할 때 사용합니다." },
        prime_5_plus: { why: "소수 편중이 매우 심한 조합만 골라내는 정밀 필터라 고급 조정에서 빛납니다." },
        prime_1_or_less: { why: "소수가 거의 없는 조합을 강하게 줄여 숫자 성격을 더 고르게 맞추고 싶을 때 적합합니다." },
        prime_0: { why: "소수가 하나도 없는 조합만 따로 걷어내는 세밀 보정용 필터입니다." },
        exclude_number: { why: "자동 규칙보다 더 직접적으로, 이번 회차에 개인적으로 빼고 싶은 번호를 반영하는 수동 필터입니다." }
    };

    Object.keys(RULE_NARRATIVES).forEach(ruleId => {
        const narrative = RULE_NARRATIVES[ruleId] && RULE_NARRATIVES[ruleId].why;
